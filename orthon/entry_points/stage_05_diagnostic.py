...
from orthon.engines.diagnostic_report import (
    run_diagnostic,
    generate_report,
    DiagnosticResult,
)
...
def run(
    ...
    """
    Run full ORTHON diagnostic on observations.
    ...
    if verbose:
        print("=" * 70)
        print("05: ORTHON DIAGNOSTIC ASSESSMENT")
        print("=" * 70)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="05: ORTHON Diagnostic")
