...
```bash
# Generic transform
python -m orthon.ingest.transform input.parquet output.parquet \
...
from orthon.ingest.transform import transform_femto
...
python -m orthon.ingest.validate observations.parquet
...
```bash
# 1. Transform
python -m orthon.ingest.transform raw_data.parquet observations.parquet \
    --entity bearing_id \
...
```python
from pathlib import Path
from orthon.ingest.transform import transform_skab
...
```python
from pathlib import Path
from orthon.ingest.transform import transform_cmapss
...
```python
from pathlib import Path
from orthon.ingest.transform import transform_fama_french
