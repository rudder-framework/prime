"""
ORTHON Schema Enforcer

Validates and transforms observations.parquet to PRISM v2.0.0 schema.
ORTHON produces correct data. PRISM shouldn't fix bad orders.
...
Usage:
    python -m orthon.ingest.schema_enforcer <observations.parquet>
    python -m orthon.ingest.schema_enforcer --fix <observations.parquet>
"""
...
Usage:
    python -m orthon.ingest.schema_enforcer <observations.parquet>
    python -m orthon.ingest.schema_enforcer --fix <observations.parquet>
    python -m orthon.ingest.schema_enforcer --fix-all <directory>
