...
Usage:
    from orthon.manifest.domain_clock import DomainClock
...
class DomainClock:
    ...
    def characterize(
        ...
        Args:
            ...
            time_col: Column name for timestamps/index (default 'I' for ORTHON)
...
if __name__ == "__main__":
    ...
    np.random.seed(42)
    n = 1000
    t = np.arange(n)  # Index-based (like ORTHON I column)
