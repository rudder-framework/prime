"""
Command-line interface for ORTHON Streaming Module.

Usage:
    python -m orthon.streaming dashboard --source turbofan
    python -m orthon.streaming analyze --source crypto --duration 60
    python -m orthon.streaming demo --source turbofan --scenario degradation
"""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="ORTHON Streaming Module - Real-time PRISM Analysis",
...
Examples:
  ...
  python -m orthon.streaming demo --scenario degradation

  # List available data sources
  python -m orthon.streaming sources
        """,
    )
