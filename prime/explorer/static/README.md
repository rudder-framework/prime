...
```bash
# Start the Rudder Framework server
uvicorn framework.api:app --reload --port 8000
...
Rudder Framework automatically detects units from column name suffixes and converts to SI.
...
Rudder Framework extracts constants from:
