...
LIMIT 50
  ...
  // Thermodynamics, Rudder Signal, Force Attribution
  // ============================================================
  physics: {
    phys_rudder_signal: {
      name: "Rudder Signal Detection",
...
SELECT
    ...
    coupling_state,
    state_trend
FROM v_rudder_signal
WHERE rudder_signal = TRUE
...
SELECT
    ...
    status_message
FROM v_rudder_entity_summary
ORDER BY current_severity_score DESC
      `
    },
    phys_fleet_summary: {
      name: "Fleet Health Overview",
      description: "Fleet-wide summary (from 16_rudder_signal.sql)",
      sql: `
SELECT
    n_entities,
    n_with_rudder_signal,
...
SELECT
    ...
    status_message
FROM v_rudder_entity_summary
WHERE current_rudder_signal = TRUE
ORDER BY current_severity_score DESC
      `
    },
    sum_narratives: {
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = RUDDER_QUERIES_V2;
}
