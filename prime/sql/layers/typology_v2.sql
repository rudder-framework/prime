...
SELECT
    ...
    -- ======================================================================
    CASE
        WHEN (signal_std < 1e-10 OR (ABS(signal_mean) > 1e-10 AND signal_std / ABS(signal_mean) < 1e-6))                          THEN 'CONSTANT'
    ...
    -- ======================================================================
    CASE
        WHEN (signal_std < 1e-10 OR (ABS(signal_mean) > 1e-10 AND signal_std / ABS(signal_mean) < 1e-6))   THEN NULL
    ...
    -- ======================================================================
    CASE
        WHEN (signal_std < 1e-10 OR (ABS(signal_mean) > 1e-10 AND signal_std / ABS(signal_mean) < 1e-6))                          THEN 0
